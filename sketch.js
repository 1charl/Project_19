...
function preload(){
  ...
  dog_collided = loadImage("download.png");
...
function draw() {
  ...
  if (gameState===PLAY){
    ...
    if((touches.length > 0 || keyDown("SPACE")) && dog.y >= height-120) {
      jumpSound.play( )
      dog.velocityY = -10;
       touches = [];
    }
